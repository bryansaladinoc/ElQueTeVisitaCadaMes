...
const client = new DeepstreamClient('192.168.71.108:4201');

window.onload = function () {
	client.login({username: client.getUid(), password: 'sesame'}, (success,data) => {
...
/* var client = deepstream('localhost:4201');
...
function startApp(data) {
	...
	var myBoxColor = '#222'
	var currentUser = client.record.getRecord(data);
